...
/* package bang-0.1.0.0 */
#ifndef VERSION_bang
#define VERSION_bang "0.1.0.0"
#endif /* VERSION_bang */
#ifndef MIN_VERSION_bang
#define MIN_VERSION_bang(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bang */
...
#define CURRENT_COMPONENT_ID "bang-0.1.0.0-inplace-bang"
